...
public class UserSignupSignInController {
	...
	public String findRoles(@PathVariable String userName) {
		System.out.println("in find roles " + userName);
		return userService.getRoles(userName);
	}
	
	@Modifying
	@DeleteMapping("/delete/{userName}")
	public ResponseEntity<?> deleteFlat(@PathVariable String userName) {
