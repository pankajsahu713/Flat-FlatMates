...
public interface UserRepository extends JpaRepository<User,Long> {
	...
	@Query("select  u.roles from User u where u.userName=:nm")
	Role fetchUserRoles(@Param("nm") String userName);
	
	@Modifying
	@Query(value = "delete from User u where u.userName=:p2")
	void deleteuser(@Param("p2") String userName);
}
