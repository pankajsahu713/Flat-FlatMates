...
//                             <button className="btn btn-danger" onClick={deleteMyAccount}><Link style={linkStyle}>Delete User</Link></button>
//                         </div>
//                         </div>
...
//                         <div className="row">
//                         <div className="mb-3 text-center">
//                             <button className="btn btn-primary ms-10"><Link style={linkStyle}>Delete property</Link></button>
//                         </div>
//                         </div>
